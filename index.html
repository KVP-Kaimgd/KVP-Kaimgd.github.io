...
<html lang="ru-RU">
<head>
<title>KvpCraft MC</title>
<meta charset="utf-8">
<meta name="description" content="KAICRAFT - крутой сервер по майнкрафт имеющий кроссплатформенность, то-есь ты можешь играть, и на Java Edition, и на Bedrock Edition .">
...
<div class="page-con-content landing-con-override">
	...
	<div class='че в коде спипином делаешь?'>
	</div>
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 KVPCRAFT - крутой сервер по майнкрафт имеющий кроссплатформенность, то есть ты можешь играть, и на Java Edition, и на Bedrock Edition.
							</p>
							<div class='landing-btn-container'>
								<div class="build-btn-button">
									<div class="build-ico-button">
										<div class="build-ico-os">
											<img alt="Windows" src="https://cdn-icons-png.flaticon.com/512/1941/1941784.png" style='height: 100%; width: 100%; object-fit: contain'/>
											<img alt="Linux"   src="https://cdn0.iconfinder.com/data/icons/communication-166/512/12-512.png" style='height: 100%; width: 100%; object-fit: contain; display:none;'/>
										</div>
									</div>
									<a href="/join">
									<div class="build-tx1-button">
										<span>играть</span>
										<span class="build-tx2-label">java/BE</span>
									</div>
									</a>
								</div>
							</div>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(https://sun9-21.userapi.com/impg/ACBNSfBxItwaIrFvNx56MKc7yocirCxriGxq3w/SpqhE6Fbvuo.jpg?size=930x1143&quality=96&sign=28bb85f8891d7b88c9dd42c855f4e56a&type=album) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 так-же у kvpcraft есть дискорд сервер, где вы можете найти друзей и пообщаться с самим создателем! (я хз наверное нет но наверное да аоаоаоаоаоаоао)
								</p>
							</div>
							<a href="https://discord.gg/5thrXvkaQA" target="_blank">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 ютуб разработчика сервера(лол там фрифайр)
								</p>
							</div>
							<a href="https://www.youtube.com/c/Kaimgd" target="_blank">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							<div class="patreon-tx1-mantra">
								<h2>ДОНАТ</h2>
								<div class="landing-con-divider" style="background: ##FFFFFF">
								</div>
							</div>
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 тут можно купить привилегии одновременно в майнкрафт, и в дискорд!
								</p>
							</div>
							<a href="https://kvpcraft.trademc.org" target="_blank">
